...
| **A06** Vulnerable & Outdated Components | Dependabot/Renovate on the monorepo (GitHub Actions integration, configured at CI milestone); pinned dependency versions; `npm audit` gate in CI pipeline |
