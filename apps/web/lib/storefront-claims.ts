...
export const STOREFRONT_CLAIMS: StorefrontClaim[] = [
  {
    ...
    resolution: 'Removed 2026-09-03 (design/ui-redesign) — no capability is coming, so there was nothing to correct it to.',
  },
  {
    id: 'dispatch-24h',
  ...
  },
  {
    ...
    resolution: 'Removed 2026-09-03 (design/ui-redesign) — no capability exists to correct it to.',
  },
  {
    ...
    status: 'resolved',
    resolvedBy: 'removed',
    reality: 'A product claim, not a system claim — nothing here could verify it.',
    resolution: 'Removed 2026-09-03 (design/ui-redesign) rather than left unverifiable. Re-add only if the client stands behind it.',
  },
  {
    id: 'live-tracking',
    ...
    reality:
      ...
      'shipping is unbuilt — so "live" overstated what a customer would see.',
    resolution:
      'Reworded 2026-09-03 to "see the status of every order" — plain, honest, and already true. ' +
      'The exact overclaiming phrase this pattern matches is gone, not corrected in place.',
  },
  {
