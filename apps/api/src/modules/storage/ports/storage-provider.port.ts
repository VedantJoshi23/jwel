...
// live/production adapter; Filesystem is the dev/test adapter — and unlike
// Payments, whose unconfigured path refuses to boot in production, the
// unconfigured adapter here is a working local one (see
// FilesystemStorageProvider): storage isn't safety-critical the way money is,
// and requiring real AWS credentials just to run this locally would block
